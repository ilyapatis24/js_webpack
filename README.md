...
**Важно**: решения должны быть построены на базе [шаблона Webpack]([/ci-template](https://github.com/netology-code/ajs-homeworks/tree/ajs8/ci-template)) (для задач под номерами 1 и 2).
